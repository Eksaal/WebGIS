...
const Hallo = () => {
  return (
    <section id="hallo" className="bg-[url('/assets/img/Gbecak1.png')] h-[40vh] w-full bg-no-repeat bg-cover mt-5">
      <div className="container h-full w-full mx-auto">
        <div className="row w-full">
          <div className="col-12 helo">
            <h2 className="text-[40px] font-extrabold text-[#262626] mt-4 ml-10">Hallo Sobat!!</h2>
            <p className="sub-title text-[16px] font-normal text-black w-1/2 mt-5 ml-10">
